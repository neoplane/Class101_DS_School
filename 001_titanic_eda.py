...
f2, ax = plt.subplots(1, 2, figsize=(18, 8))
...
f3, ax = plt.subplots(1, 2, figsize=(18, 8))
...
f4, ax = plt.subplots(1, 2, figsize=(18, 8))
...
f5, ax = plt.subplots(1, 2, figsize=(20, 10))
...
f6, ax = plt.subplots(2, 2, figsize=(20, 15))
...
f7, ax = plt.subplots(1, 2, figsize=(20, 8))
...
f8, ax = plt.subplots(1, 2, figsize=(20, 8))
...
f9, ax = plt.subplots(1, 3, figsize=(20, 8))
...
data['Age_band'].value_counts().to_frame().style.background_gradient(
    cmap='summer')  # checking the number of passenegers in each band
...
f10, ax = plt.subplots(1, 2, figsize=(18, 6))
...
xgboost2 = xgboost.XGBClassifier(n_estimators=900, learning_rate=0.1)
result = cross_val_score(xgboost2, X, Y, cv=10, scoring='accuracy')
...
f11, ax = plt.subplots(2, 2, figsize=(15, 12))
...
model = xgboost.XGBClassifier(n_estimators=900, learning_rate=0.1)
model.fit(X, Y)
